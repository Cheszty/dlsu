...
<div class="login-box">
    <div class="login-box-body" style="padding: 50px 30px;">
      <div style="width: 100%;text-align: center;">
        ...
        <h3 class="text-center" style="width: 100%;padding: 5px;"><a href="register.php" class="text-decoration-none" style="color: #000;">Forgot Password</a></h3>
      <br>
      <br>
      <form action="controller/forgotpasswordController.php" method="POST">
          ...
          <div class="row">
          <div class="col-xs-12">
                <button type="submit" class="btn btn-block btn-flat" style="background: #00bf63; color: #fff; border: unset;height: 45px;font-size: 23px;" name="sendemail">Send Email</button>
              </div>
          </div>
      </form>
      <br>
