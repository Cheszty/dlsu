      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="../controller/teamsController.php">
          ...
          <div class="form-group" id="redefense_comment_group" style="display: none;">
            ...
            <div class="col-sm-12">
              <textarea class="form-control" id="redefense_comment" name="redefense_comment" rows="4" placeholder="Provide a comment here"></textarea>
            </div>
          </div>
          <div class="form-group">
...
<div class="modal fade" id="editPanelist">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
        <button type="submit" class="btn btn-success" name="edit_panelist"><i class="fa fa-save"></i> Save</button>
        </form>
      </div>
    </div>
  </div>
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="../controller/teamsController.php">
          ...
          <div class="text-center">
            ...
            <h2 class="bold" id="delete_panelist_name" style="word-break: break-word; max-width: 100%; overflow-wrap: break-word;"></h2>
          </div>
      </div>
      <div class="modal-footer">
