    ...
    <div class="content-wrapper" style="height: 100vh;background-color: #f9f9f9;overflow-y: auto;">
      <section class="content">
            ...
            <?php if($_SESSION['type'] != 1): ?>
                        ...
                        <tr>
                          ...
                          <td class="text-center" style="font-size: 23px;font-style: normal;">
                            ...
                            <?php else: ?>
                                ...
                                data-chng-rt="<?=$row['adviser']?>"
                                >Change adviser</button>
                            <?php endif ?>
                          </td>
                        </tr>
                      <?php endwhile ?>
                ...
                <div class="col-4">
                  <table id="example1" style="border-spacing: 20px; border-collapse: separate;">
                    <thead>
                      <th style="font-size: 23px;font-style: normal;">Count of Assigned Sections</th>
                      <th style="font-size: 23px;font-style: normal;">Faculty Name</th>
                    </thead>
                    <tbody>
                       <?php 
                            $sql = "SELECT 
                        ...
                        <tr>
                          ...
                          <td style="font-size: 23px;font-style: normal; text-align:left;"><?=$faculty_name?></td>
                        </tr>
                      <?php endwhile ?>
                    </tbody>
                  </table>
