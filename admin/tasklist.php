                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <?php if($_SESSION['type'] == 2): ?>
                              ...
                              data-uploadfile_setdeadline_id='<?php echo $row['setdeadline_id'] ?>'
                              >UPLOAD FILE</button>
                            <?php endif;?>
                    ...
                    <tbody>
                      ...
                      while ($row = $stmt->fetch()) { ?>
                        <tr>
                          <td style="font-size: 23px;font-style: normal;"><?php echo $row['name'] ?></td>
                          <td>
                            <a href="viewtasklist.php?teams_id=<?php echo $row['teams_id'] ?>" class='btn btn-warning btn-sm btn-table' 
                            >VIEW</a>
                          </td>
                        </tr>
                      <?php } ?>
