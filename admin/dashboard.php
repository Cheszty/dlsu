...
?>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
      ...
      <script>
        ...
        $(document).on('click', '.taskcommentdashboard', function() {
          const taskId = $(this).val(); // Get the task ID from the button value

          // Set the task_id in the hidden input field
          $('#taskcomment_task_id').val($(this).val()); // This is where you added it
