...
.sidebar-menu a:hover {
    background: darkblue;  /* Regular dark blue on hover */
    color: white;
}

.sidebar-menu a:hover i {
    color: white; /* Make icons white on hover */
}

/* Active State */
.sidebar-menu a.active {
    background: #0b3d91;  /* Darker blue for active state */
    color: white;
}

.sidebar-menu a.active i {
    color: white; /* Make icons white when active */
}
        ...
        .sidebar-profile img {
            ...
            border-radius: 50%;
            object-fit: cover;
            border: 2px solid #1d4e89; /* Dark Blue Border */
        }
        ...
        .sidebar-profile .profile-info .name {
            font-weight: 600;
            font-size: 14px;
            color: #1d4e89;  /* Dark Blue Name */
        }

        .sidebar-profile .profile-info .role {
            font-size: 12px;
            color: #1d4e89;  /* Dark Blue Role */
        }
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li>
                ...
                $row = $stmt->fetch();
                ?>
                <a href="#profile" data-toggle="modal" class="sidebar-profile">
